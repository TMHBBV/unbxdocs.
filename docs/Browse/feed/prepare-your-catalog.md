...
uniqueId (mandatory field)	false	text	Unique identifier of a product. It cannot have special character except ‘-’ and ‘*’
variantId	false	text	Unique identifier of a variant (if present). It cannot have special character except ‘-’ and ‘*’. It needs to be unique across entire product catalog.
