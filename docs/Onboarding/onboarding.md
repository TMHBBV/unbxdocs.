...
Our Netcore Unbxd’s AI identifies the relevant set of synonyms, searchable fields, and facets in accordance with your product catalog upfront. The AI recommendation sorts your entire catalog by deciding which fields should be marked searchable along with their search weights.
...
You can also refer to the video to set up your site search using Netcore Unbxd’s new Onboarding console:
