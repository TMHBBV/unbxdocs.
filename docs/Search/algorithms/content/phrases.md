...
A search for **"paint brush"** could return a mix of *any* product related to 'paint' (like cans of paint) and *any* product related to 'brush' (like hair brushes), alongside actual paint brushes. This happens if the engine isn't well-trained or lacks sufficient data to understand the combined meaning.
