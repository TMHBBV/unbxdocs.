...
| **Operators**            | Conditions used to create rules by comparing attributes and their values.\<ui>\<li>\*\*Equals (=)\*\*: The attribute value must exactly match the specified value. Example: Brand = Nike |
