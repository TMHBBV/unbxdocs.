...
metadata:
  robots: index
---
## Redirect queries to static pages
...
5. On the Redirects overview page, navigate to Add redirect.
6. You'll go to the Add banners interface.
7. Enter the Query for which you want to set up redirects—this is the search term you expect your shopper to use.
...
8. Enter a Campaign Name for internal reference.
9. Select a Segment from the list to target specific shopper groups or click + Create New Segment to make a custom/new one.
10. Set the Duration for the campaign, including the Time Zone, Start and End dates, and times.
...
11. Optionally, add a Description for future reference.
12. When finished, click Next to proceed.\
    title="Configuring the redirect"
13. Enter the redirect URL. Make sure the URL entered is publicly accessible and operational. Netcore Unbxd will not determine the validity of the URL provided.
14. You can preview the redirect URL by clicking the Preview button on the instant preview section.

title="Saving or publishing the redirect">\
