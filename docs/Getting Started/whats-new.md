...
## Let AI Optimize Your User Experience using AI Suggested Redirects !
...
## Debug Just Got Smarter with Product Insights
...
## Enhanced Filter & Boost Conditions
...
## Manage Autosuggest - New Enhancements for Real-Time Suggestions
...
## Two-Factor Authentication (2FA) – Boost Your Security with an Extra Layer of Protection!
...
## Website Preview for Enhanced Debugging Capabilities
...
## Bulk Export/Import Field Configurations
...
## Bulk Upload for Searchable Fields
...
## Smarter Site Picker Experience
...
## Enhanced Merchandising Enhancements
...
* *Note: Only available for live campaigns.*
...
## Friendlier Toast Notifications
...
## Unified and Improved Admin Portal
...
## More intelligent Table Behavior Across the Platform
...
## Stronger Password & Session Policies
...
## Streamlined Searchable Fields Workflow
...
## A/B Testing Metric Labels – Refreshed and Reframed
